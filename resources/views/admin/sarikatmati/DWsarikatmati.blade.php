...
<!--กลุ่มปุ่ม ButtonGroup-->
                    ...
                    <a href="{{ route('sarikatmati.index') }}"  class="btn btn-outline-secondary text-dark">สมัครซารีกัตมาตี</a>
                    <a href="#"  class="btn btn-outline-secondary text-dark">จ่ายเงิน</a>
                    <a href="{{ route('Wsrikatmati') }}"  class="btn btn-outline-secondary text-dark">ถอนเงิน</a>
                </div>
                </div>
        ...
        <div class=" row ">
            <div class=" col-lg-10 mx-auto">
                <div class="row mt-5">
                    <div class="col-md-12 ">
                        <h3 class="text-center">จ่ายซารีกัตมาตี</h3>
                    </div>
                </div>
