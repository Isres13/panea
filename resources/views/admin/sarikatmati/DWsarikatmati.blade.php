...
<!-- Flex -->   <div class="alert " style="background: #3C8085;  margin-bottom: 0rem; ">
                    <div class="d-flex align-items-center ">
                        <div class=" ms-3"   >
                            <p class="h3 fw-bold text-white ">จ่ายซารีกัตมาตี</p>
                        </div>
                    </div>
                </div>
...
<!--กลุ่มปุ่ม ButtonGroup-->
                    ...
                    <a href="#"  class="btn btn-outline text-light active" style="Background: #3C8085; ">จ่ายเงิน</a>
                    ...
                    <div class="alert alert-Light border rounded-1 p-1  mt-3" role="alert">
                        <div class="continea">
                            <div class="row ">
                                <div class="mx-auto">
                                    <div class=""row mt-4>
                                        <h3 class="text-center mt-3">ข้อมูลจ่ายซารีกัตมาตี</h3>
...
<div class="modal" id="deposit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            ...
            @endif
            <form  class="mt-3" action="{{ route('DWcsarikatmati.store') }}" method="post">
                        @csrf
                            <div class="mx-aotu">
                                <div class="row ">
                                    <div class="col ">
                                    ...
                                    <div class="col ">
                                        ...
                                        <select class="form-control " aria-label="Default select example" name="employee_id" placeholder="--รหัสคณะกรรมการ--"><option>
                                        @foreach($employee as $row)
                                        <option  value="{{$row->id}}">{{$row->employee_id}}@endforeach </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
